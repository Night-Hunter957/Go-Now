...
<div>
  <div class="amap-page-container" ref="map">
    <el-amap vid="amapDemo" :amap-manager="amapManager" :center="center" :zoom="zoom" :plugin="plugin" class="amap-demo" :aotuLoaction="true">
    </el-amap>
  </div>
...
export default {
  data () {
    return {
      ...
      plugin: ['ToolBar', 'MapType', 'Geolocation']
    }
  },
  mounted () {
